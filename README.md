```
0xC00800FF - ADDI $zero, 255, $a0 -> R[4] = 0x000000FF.
0xC00A0A01 - ADDI $zero, 2561, $a1 ->  R[5] = 0x00000A01.
...
0xC009FFFF - ADDI $zero, -1, $a0 -> R[4] = 0xFFFFFFFF
0xC00A0002 - ADDI $zero, 2, $a1 -> R[5] = 0x00000002
